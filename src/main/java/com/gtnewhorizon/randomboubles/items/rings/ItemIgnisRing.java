...
public class ItemIgnisRing extends ItemBaubleRingBase implements IPrimordialGemCrafting {

    static final int RING_COUNT = 3;
    private IIcon[] icons;

    public ItemIgnisRing() {
        super();
        this.setUnlocalizedName("ignisRing");
        this.setTextureName("ignisRing");
    }
